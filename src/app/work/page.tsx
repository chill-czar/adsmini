  ...
  return (
    <div className="text-ink font-body-lg bg-[#F9F9F9]">
      <main className="relative w-full max-w-[1920px] mx-auto pb-section-gap overflow-hidden">
        {/* Hero Section */}
        <section className="relative pt-section-gap px-margin-mobile md:px-margin-desktop mb-section-gap">
          <div className="grid-12 relative z-10">
            ...
            <div className="col-span-12 md:col-span-6 md:col-start-4 mt-12 md:mt-24">
              <p className="font-body-lg text-body-lg text-ink font-semibold border-l-4 border-tangerine pl-6">
        ...
        {/* Divider Line */}
        <div className="w-full h-px bg-ink my-12 opacity-20"></div>

        {/* Google Ads Section */}
        <section className="relative py-section-gap px-margin-mobile md:px-margin-desktop">
          <div className="grid-12 items-center">
            <div className="col-span-12 md:col-span-5 relative">
              <p className="font-label-mono text-label-mono text-tangerine uppercase mb-4 tracking-widest">[ GOOGLE ADS ]</p>
              <h2 className="font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg uppercase mb-8">
                Dominating<br />Search<br />
                <span className="text-outline">Intent</span>
              </h2>
              <ul className="space-y-4 font-headline-md text-headline-md text-ink">
            ...
            <div className="col-span-12 md:col-span-6 md:col-start-7 mt-16 md:mt-0 relative flex justify-center">
              {/* Massive stat visual */}
              <div className="relative w-full max-w-md aspect-square bg-ink text-paper rounded-full flex flex-col items-center justify-center p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500 shadow-[16px_16px_0px_0px_#FA9948]">
                <p className="font-label-mono text-label-mono uppercase tracking-widest text-tangerine mb-4">Avg. ROAS</p>
                <p className="font-display-xl text-display-xl leading-none">10.2x</p>
              </div>
              {/* Decorative Mascot */}
              <Image unoptimized width={1000} height={1000}                 alt="Mascot leaning on large data figure"
                className="absolute -bottom-10 -right-10 w-40 mix-blend-multiply"
                src="https://lh3.googleusercontent.com/aida/AP1WRLv23ksB56h_ljfULkaavUo6ijM9ZUxdbusQJsmQ_LVOxgvcoZ0wb4ijI3NczXv2iyQAbLGzpFGMSLMOT9DI5oqLKf4ZdCCfUIfla9VUmTntDUTXdfdkIvY4HuuCJwAQMfnwKEcoa9gZQgs9gnRSzcsaLThtThSSO-J5HyWO6EMx246xLz4SroenIZoUoVeu1tQ8V72BhW_Df1Q4JDm14pX84_P-mi6zhoOS2yBf1Sb11krQYdtOIG5bnwM"
              />
            </div>
          </div>
        ...
        <div className="relative w-full h-32 my-12 flex justify-center items-center overflow-hidden">
        ...
        {/* Meta Ads Section */}
        <section className="relative py-section-gap px-margin-mobile md:px-margin-desktop bg-ink text-paper">
          <div className="grid-12">
            ...
            <div className="col-span-12 md:col-span-11 grid-12">
              ...
              <div className="col-span-12 md:col-span-7">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12 font-body-lg">
                  <div className="border-t-2 border-paper pt-4">
                    <h3 className="font-headline-md text-headline-md uppercase mb-2">Sizzle</h3>
                    <p className="font-label-mono text-label-mono text-secondary">F&amp;B</p>
                  </div>
                  <div className="border-t-2 border-paper pt-4">
                    <h3 className="font-headline-md text-headline-md uppercase mb-2">The Digital Bundle</h3>
                    <p className="font-label-mono text-label-mono text-secondary">Agency</p>
                  </div>
                  <div className="border-t-2 border-paper pt-4">
                    <h3 className="font-headline-md text-headline-md uppercase mb-2">Okapi</h3>
                    <p className="font-label-mono text-label-mono text-secondary">E-Commerce</p>
                  </div>
                  <div className="border-t-2 border-paper pt-4">
                    <h3 className="font-headline-md text-headline-md uppercase mb-2">GT Groups</h3>
                    <p className="font-label-mono text-label-mono text-secondary">Real Estate</p>
                  </div>
                  <div className="border-t-2 border-paper pt-4">
                    <h3 className="font-headline-md text-headline-md uppercase mb-2">Catchy Trade</h3>
                    <p className="font-label-mono text-label-mono text-secondary">Finance</p>
                  </div>
                  <div className="border-t-2 border-paper pt-4">
                    <h3 className="font-headline-md text-headline-md uppercase mb-2">Stabo Life</h3>
                    <p className="font-label-mono text-label-mono text-secondary">Health</p>
                  </div>
                  <div className="border-t-2 border-paper pt-4 md:col-span-2">
                    <h3 className="font-headline-md text-headline-md uppercase mb-2">S&amp;A Renovation</h3>
