    ...
    <footer className="bg-surface-container-lowest text-ink w-full relative border-t-ink-4">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter px-margin-mobile md:px-margin-desktop py-16 md:py-section-gap w-full overflow-hidden bg-grid-pattern">
        ...
        <div className="md:col-span-12 flex flex-wrap justify-center gap-x-6 gap-y-4 md:gap-x-12 md:gap-y-8 bg-ink border-ink-4 p-6 md:p-12 brutalist-shadow text-surface-container-lowest">
          <Link href="#" className="text-[18px] md:text-[32px] font-black uppercase px-4 py-2 hover:bg-tangerine hover:text-ink transition-all duration-300">STRATEGY</Link>
          <Link href="#" className="text-[18px] md:text-[32px] font-black uppercase px-4 py-2 hover:bg-tangerine hover:text-ink transition-all duration-300">CREATIVE</Link>
          <Link href="#" className="text-[18px] md:text-[32px] font-black uppercase px-4 py-2 hover:bg-tangerine hover:text-ink transition-all duration-300">MEDIA</Link>
          <Link href="/services/recruitment" className="text-[18px] md:text-[32px] font-black uppercase px-4 py-2 hover:bg-tangerine hover:text-ink transition-all duration-300">RECRUITMENT</Link>
          <Link href="#" className="text-[18px] md:text-[32px] font-black uppercase px-4 py-2 hover:bg-tangerine hover:text-ink transition-all duration-300">INSTAGRAM</Link>
          <Link href="#" className="text-[18px] md:text-[32px] font-black uppercase px-4 py-2 hover:bg-tangerine hover:text-ink transition-all duration-300">LINKEDIN</Link>
        </div>
